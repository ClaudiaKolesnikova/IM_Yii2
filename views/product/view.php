...
<?php if($product->new):?>
<?= Html::img("@web/images/product-details/new.jpg", ['class' => 'newarrival', 'alt' => 'Новинка'])?>
<?php endif;?>
<?php if($product->sale):?>
...
<!--                            <p><b>Condition:</b> New</p>-->
                            ...
                            <?= Html::img("@web/images/product-details/share.png", ['alt' => "", 'class' => "share img-responsive"])?>
                            <?=$product->content?>
                ...
                <div class="single-products">
                    <div class="productinfo text-center">
                        <a href="<?= Url::to(['product/view', 'id' => $hit->id])?>">
                            <?= Html::img($recomImg->getUrl(), ['alt' => $hit->name])?></a>
                        <h2>$<?=$hit->price?></h2>
